...
5. **Generate checklist** - Create "Unit Tests for Requirements":
   ...
   - Each `/speckitsmart.checklist` run creates a NEW file (never overwrites existing checklists)
...
**Important**: Each `/speckitsmart.checklist` command invocation creates a checklist file using short, descriptive names unless file already exists. This allows:
