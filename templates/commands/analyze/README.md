...
1. **01-setup-and-scope.md** (~600 lines) - Unified setup, project path, and scope definition
2. **02-structure.md** (~300 lines) - Project structure analysis
3. **03-file-analysis.md** (~450 lines) - ⭐ **CRITICAL** Deep file scanning
4. **04a-full-app.md** (~400 lines) - Branch A: Full application modernization
5. **04b-cross-cutting.md** (~350 lines) - Branch B: Cross-cutting concern migration
6. **05-report-generation.md** (~300 lines) - Analysis report generation
7. **06-artifacts.md** (~350 lines) - Remaining artifacts generation
...
│   ├── 00-bootstrap.json                 # Intermediate (script output, Stage 1 only)
│   ├── 01-setup-and-scope.json           # Stage 1 output
│   ├── 02-structure.json                 # Stage 2 output
│   ├── 03-file-analysis.json             # Stage 3 output
│   ├── 04a-full-app.json                 # Stage 4A output (OR 04b-cross-cutting.json)
│   ├── 05-report.json                    # Stage 5 output
│   ├── 06-artifacts.json                 # Stage 6 output
│   └── latest.json                       # Symlink to most recent state
└── {project}-{timestamp}/                # Analysis workspace
    ├── file-manifest.json                # ← Generated by script in Stage 1
    ├── analysis-report.md                # Generated by Stage 5
    ├── EXECUTIVE-SUMMARY.md              # Generated by Stage 6
    └── ... (other artifacts)
```
