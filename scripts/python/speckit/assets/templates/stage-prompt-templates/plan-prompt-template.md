...
**Input Source**: `analysis/technical-spec-target.md`
...
Use `technical-spec-target.md` for target architecture and tech stack.
...
BASE ARCHITECTURE: Use analysis/technical-spec-target.md
...
Full stack details in technical-spec-target.md §8.

ARCHITECTURE PATTERN: <<from technical-spec-target.md §2>>
- Legacy: <<current pattern>>
- Target: <<chosen pattern>> (rationale: <<why>>)

MIGRATION STRATEGY: <<from technical-spec-target.md §12>>
- Approach: Strangler Fig / Blue-Green / <<other>>
- Phasing: P1 (months 1-3), P2 (months 4-6), P3 (months 7-9)

NFR TARGETS (measurable SLO/SLI): See technical-spec-target.md §9
- Performance: p95 < <<target>>ms
- Availability: <<target>>% uptime
- Scalability: <<target>> concurrent users

COMPONENT DESIGN: See technical-spec-target.md §5
