...
3. Display resume message:
   ...
   Last completed: Chunk 2 (User Stories - CRITICAL)
...
3. **MANDATORY - Display progress**:
   ...
   ```text
   ✓ Chunk 2/5 complete: User Stories (CRITICAL)
...
2. **MANDATORY - Display progress**:
   ...
   ```text
   ✓ Chunk 3/5 complete: STANDARD Features + Business Rules
...
2. **MANDATORY - Display progress**:
   ...
   ```text
   ✓ Chunk 4/5 complete: NFRs + Data Requirements
...
2. **MANDATORY - Display progress and final summary**:
   ...
   ```text
   ✓ Chunk 5/5 complete: Acceptance + Assumptions + Constraints
